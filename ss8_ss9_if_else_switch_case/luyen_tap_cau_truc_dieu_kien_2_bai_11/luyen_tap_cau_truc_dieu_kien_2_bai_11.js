function bn(){
    ...
    if (thu_nhap <= 5000000){
        ...
        document.getElementById("result").innerHTML = "Thu nhập cá nhân của bạn là: " + (thu_nhap*80/100 - 250000) + "VNĐ"
    }else if (thu_nhap <= 15000000){
        document.getElementById("result").innerHTML = "Thu nhập cá nhân của bạn là: " + (thu_nhap*70/100 - 750000) + "VNĐ"
    }else {
